...
#
#
#@default_excluded_files = ('authorshipAndContributions.tex');  
#
## Add custom dependencies
#add_cus_dep( 'tex', 'bib', 0, 'makebib' );
#add_cus_dep( 'bib', 'bbl', 0, 'makebbl' );
#
## Custom function to run BibTeX
#sub makebib {
#    system("bibtex paper");
#}
#
## Custom function to generate .bbl file
#sub makebbl {
#    return system("pdflatex paper.tex");
#}
#
## Set the compiler
#$pdflatex = 'pdflatex --interaction=nonstopmode paper.tex';
#
## Set the number of compiler passes
#$max_repeat = 4;
#
## Clean up auxiliary files
#$clean_ext = "bbl bib aux log dvi ps bak blg synctex.gz out";
#
## Make sure that we are only using PDF files
#$pdf_mode = 1;
